export const EASTER_EGGS = [
  ...
  // --- Batch 12: Game Day ---
  {
    ...
    size: [28, 28],
    title: 'Rays Up!',
    fact: "The Tampa Bay Rays have been one of baseball's most innovative franchises — consistently competing despite one of MLB's smallest payrolls. Their new Gas Plant District stadium promises a new era for St. Pete baseball.",
    svgKey: 'raysBaseball',
    animCategory: 'sports',
  },
  {
    ...
    size: [26, 32],
    title: 'Fore!',
    fact: "Innisbrook Resort's Copperhead Course in Palm Harbor hosts the PGA Tour's Valspar Championship every spring. The hilly, tree-lined layout is one of the toughest tests on Tour — a rarity in flat Florida.",
    svgKey: 'golfFlag',
    animCategory: 'sports',
  },
  {
    ...
    fact: "Tampa Bay Downs in Oldsmar has hosted live thoroughbred racing since 1926. It's one of the last remaining tracks in Florida, running its season from late November through May.",
    svgKey: 'horseRacing',
    animCategory: 'sports',
  },
];
