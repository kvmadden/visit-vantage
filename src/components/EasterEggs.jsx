...
export const SVG_GENERATORS = {
  ...
  pirateShip(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="22" viewBox="-2 -1 32 22">
      ...
      <path d="M-2 17 Q3.5 16 7 17 Q10.5 18 14 17 Q17.5 16 21 17 Q24.5 18 30 17" fill="none" stroke="${ocean}" stroke-width="1.2" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <path d="M-2 19 Q3.5 18 7 19 Q10.5 20 14 19 Q17.5 18 21 19 Q24.5 20 30 19" fill="none" stroke="${ocean}" stroke-width="1" stroke-opacity="${o * 0.3}" stroke-linecap="round"/>
      <!-- hull: wide U-shape with flat deck — wooden brown -->
      <path d="M2 10 L2 14 Q3 16.5 14 16.5 Q25 16.5 26 14 L26 10" fill="${brown}" fill-opacity="${o * 0.35}" stroke="${brown}" stroke-width="1.8" stroke-opacity="${o * 0.8}" stroke-linejoin="round"/>
      <!-- flat deck line -->
      <line x1="2" y1="10" x2="26" y2="10" stroke="${brown}" stroke-width="1.8" stroke-opacity="${o * 0.8}" stroke-linecap="round"/>
      <!-- hull planking lines -->
      <line x1="3" y1="12" x2="25" y2="12" stroke="${brown}" stroke-width="0.6" stroke-opacity="${o * 0.3}"/>
      <line x1="3" y1="14" x2="25" y2="14" stroke="${brown}" stroke-width="0.6" stroke-opacity="${o * 0.3}"/>
      <!-- bowsprit -->
      <line x1="2" y1="10" x2="0" y2="8" stroke="${brown}" stroke-width="1.5" stroke-opacity="${o * 0.8}" stroke-linecap="round"/>
      <!-- stern rise -->
      <path d="M26 10 L27 8.5" fill="none" stroke="${brown}" stroke-width="1.5" stroke-opacity="${o * 0.7}" stroke-linecap="round"/>
      <path d="M27 8.5 Q27.5 7.5 27 7" fill="none" stroke="${k}" stroke-width="0.8" stroke-opacity="${o * 0.4}" stroke-linecap="round"/>
      <!-- main mast -->
      <line x1="14" y1="1" x2="14" y2="10" stroke="${brown}" stroke-width="1.8" stroke-opacity="${o * 0.7}" stroke-linecap="round"/>
      <!-- crow's nest -->
      <line x1="12.5" y1="3.5" x2="15.5" y2="3.5" stroke="${brown}" stroke-width="1.2" stroke-opacity="${o * 0.6}" stroke-linecap="round"/>
      <path d="M12.5 3.5 Q12 4.5 12.5 5" fill="none" stroke="${brown}" stroke-width="0.8" stroke-opacity="${o * 0.4}"/>
      <path d="M15.5 3.5 Q16 4.5 15.5 5" fill="none" stroke="${brown}" stroke-width="0.8" stroke-opacity="${o * 0.4}"/>
      <!-- main sail — cream colored -->
      <path d="M14 1.5 Q19 3 22 5 L22 8 Q19 7 14 8 Z" fill="${cream}" fill-opacity="${o * 0.5}" stroke="${k}" stroke-width="1.2" stroke-opacity="${o * 0.8}" stroke-linejoin="round"/>
      <!-- sail rigging lines -->
      ...
      <!-- fore mast -->
      <line x1="8" y1="3" x2="8" y2="10" stroke="${brown}" stroke-width="1.5" stroke-opacity="${o * 0.7}" stroke-linecap="round"/>
      <!-- fore sail — cream -->
      <path d="M8 3 Q4 5 2 7 L2 9.5 Q5 8 8 8.5 Z" fill="${cream}" fill-opacity="${o * 0.4}" stroke="${k}" stroke-width="1.2" stroke-opacity="${o * 0.7}" stroke-linejoin="round"/>
      <!-- jolly roger flag — black with white skull -->
      <rect x="14.2" y="1" width="4" height="2.8" rx="0.3" fill="#1E293B" fill-opacity="${o * 0.8}" stroke="#1E293B" stroke-width="0.8" stroke-opacity="${o}"/>
      <circle cx="16.2" cy="1.8" r="0.6" fill="#F8FAFC" fill-opacity="${o * 0.9}"/>
      <line x1="15.4" y1="3" x2="17" y2="3" stroke="#F8FAFC" stroke-width="0.5" stroke-opacity="${o * 0.7}"/>
      <!-- rigging ropes -->
      ...
      <!-- cannon ports -->
      <rect x="6" y="11" width="1.4" height="1" rx="0.3" fill="#1E293B" fill-opacity="${o * 0.5}"/>
      <rect x="9.5" y="11" width="1.4" height="1" rx="0.3" fill="#1E293B" fill-opacity="${o * 0.5}"/>
      <rect x="13" y="11" width="1.4" height="1" rx="0.3" fill="#1E293B" fill-opacity="${o * 0.5}"/>
      <rect x="16.5" y="11" width="1.4" height="1" rx="0.3" fill="#1E293B" fill-opacity="${o * 0.5}"/>
      <rect x="20" y="11" width="1.4" height="1" rx="0.3" fill="#1E293B" fill-opacity="${o * 0.5}"/>
      <!-- red trim stripe on hull -->
      <line x1="3" y1="13" x2="25" y2="13" stroke="${red}" stroke-width="0.6" stroke-opacity="${o * 0.4}"/>
      <!-- water splash at bow -->
      <path d="M1 15 Q0 14 1 13" fill="none" stroke="${ocean}" stroke-width="0.8" stroke-opacity="${o * 0.3}" stroke-linecap="round"/>
      <path d="M0 16 Q-0.5 15 0.5 14" fill="none" stroke="${ocean}" stroke-width="0.6" stroke-opacity="${o * 0.2}" stroke-linecap="round"/>
      <!-- wake trail -->
      <path d="M26 15 Q27 14.5 28 15.5" fill="none" stroke="${ocean}" stroke-width="0.7" stroke-opacity="${o * 0.25}" stroke-linecap="round"/>
    </svg>`;
  ...
  kraken(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="40" height="30" viewBox="-2 -2 40 30">
      <!-- waterline -->
      <path d="M-2 22 Q8 21 18 22 Q28 23 38 22" fill="none" stroke="${k}" stroke-width="1.2" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <!-- dome head — deep purple -->
      <path d="M12 20 Q12 14 13 10 Q14 7 18 5 Q22 7 23 10 Q24 14 24 20" fill="${purple}" fill-opacity="${o * 0.25}" stroke="${purple}" stroke-width="1.8" stroke-opacity="${o * 0.8}" stroke-linecap="round" stroke-linejoin="round"/>
      <!-- head bumps/texture -->
      <path d="M14 8 Q16 6 18 5.5" fill="none" stroke="${purple}" stroke-width="0.6" stroke-opacity="${o * 0.3}"/>
      <path d="M18 5.5 Q20 6 22 8" fill="none" stroke="${purple}" stroke-width="0.6" stroke-opacity="${o * 0.3}"/>
      <circle cx="16" cy="7" r="0.5" fill="${purple}" fill-opacity="${o * 0.2}"/>
      <circle cx="20" cy="7" r="0.4" fill="${purple}" fill-opacity="${o * 0.15}"/>
      <!-- eyes — yellow dots -->
      <circle cx="15.5" cy="11" r="1.1" fill="${yellow}" fill-opacity="${o * 0.9}"/>
      <circle cx="20.5" cy="11" r="1.1" fill="${yellow}" fill-opacity="${o * 0.9}"/>
      <!-- eye pupils -->
      <circle cx="15.5" cy="11" r="0.4" fill="${dark}" fill-opacity="${o * 0.8}"/>
      <circle cx="20.5" cy="11" r="0.4" fill="${dark}" fill-opacity="${o * 0.8}"/>
      <!-- open mouth — dark opening -->
      <ellipse cx="18" cy="15.5" rx="2" ry="1.5" fill="${dark}" fill-opacity="${o * 0.2}" stroke="${purple}" stroke-width="1" stroke-opacity="${o * 0.7}"/>
      <!-- inside mouth -->
      <ellipse cx="18" cy="15.5" rx="1.2" ry="0.8" fill="${dark}" fill-opacity="${o * 0.4}"/>
      <!-- TENTACLE 1 — far left, teal -->
      ...
      <circle cx="0" cy="4" r="0.7" fill="${coral}" fill-opacity="${o * 0.6}"/>
      <circle cx="1" cy="9" r="0.6" fill="${coral}" fill-opacity="${o * 0.45}"/>
      <!-- TENTACLE 2 — left -->
      ...
      <circle cx="4" cy="4" r="0.55" fill="${coral}" fill-opacity="${o * 0.5}"/>
      <circle cx="5" cy="9" r="0.5" fill="${coral}" fill-opacity="${o * 0.4}"/>
      <!-- TENTACLE 3 — right -->
      ...
      <circle cx="32" cy="4" r="0.55" fill="${coral}" fill-opacity="${o * 0.5}"/>
      <circle cx="31" cy="9" r="0.5" fill="${coral}" fill-opacity="${o * 0.4}"/>
      ...
      <circle cx="36" cy="4" r="0.7" fill="${coral}" fill-opacity="${o * 0.6}"/>
      <circle cx="35" cy="9" r="0.6" fill="${coral}" fill-opacity="${o * 0.45}"/>
      <!-- water splashes -->
      <path d="M0 22 Q1 21 2 22" fill="none" stroke="${k}" stroke-width="0.7" stroke-opacity="${o * 0.3}" stroke-linecap="round"/>
      <path d="M34 22 Q35 21 36 22" fill="none" stroke="${k}" stroke-width="0.7" stroke-opacity="${o * 0.3}" stroke-linecap="round"/>
    </svg>`;
  ...
  mermaid(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="24" viewBox="-2 -2 22 28">
      ...
      <!-- flowing hair — red/auburn -->
      <path d="M6 3 Q4 5 3 8 Q2.5 10 3 11" fill="none" stroke="${red}" stroke-width="1.2" stroke-opacity="${o * 0.6}" stroke-linecap="round"/>
      <path d="M7 2.5 Q5 5 4.5 8" fill="none" stroke="${red}" stroke-width="1" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <path d="M12 3 Q14 5 15 8 Q15.5 10 15 11" fill="none" stroke="${red}" stroke-width="1.2" stroke-opacity="${o * 0.6}" stroke-linecap="round"/>
      <path d="M11 2.5 Q13 5 13.5 8" fill="none" stroke="${red}" stroke-width="1" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <!-- head -->
      <circle cx="9" cy="3.5" r="2.8" fill="${skin}" fill-opacity="${o * 0.15}" stroke="${k}" stroke-width="1.5" stroke-opacity="${o}"/>
      <!-- face details -->
      <circle cx="7.8" cy="3" r="0.5" fill="${k}" fill-opacity="${o * 0.8}"/>
      <circle cx="10.2" cy="3" r="0.5" fill="${k}" fill-opacity="${o * 0.8}"/>
      <path d="M8.5 4.5 Q9 5 9.5 4.5" fill="none" stroke="${coral}" stroke-width="0.8" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <!-- torso -->
      <path d="M7.5 6 Q7 8 7.5 10 Q8 11 9 11 Q10 11 10.5 10 Q11 8 10.5 6" fill="${skin}" fill-opacity="${o * 0.12}" stroke="${k}" stroke-width="1.2" stroke-opacity="${o * 0.8}"/>
      <!-- arms reaching up -->
      ...
      <!-- shell bikini detail — coral pink -->
      <circle cx="8.2" cy="7.5" r="0.6" fill="${coral}" fill-opacity="${o * 0.6}" stroke="${k}" stroke-width="0.5" stroke-opacity="${o * 0.4}"/>
      <circle cx="9.8" cy="7.5" r="0.6" fill="${coral}" fill-opacity="${o * 0.6}" stroke="${k}" stroke-width="0.5" stroke-opacity="${o * 0.4}"/>
      <!-- tail — teal colored -->
      <path d="M9 11 Q9 14 8.5 16 Q8 18 8 20" fill="${teal}" fill-opacity="${o * 0.35}" stroke="${teal}" stroke-width="2.5" stroke-opacity="${o * 0.7}" stroke-linecap="round" stroke-linejoin="round"/>
      <!-- tail scale texture -->
      ...
      <!-- tail fluke — teal fins -->
      <path d="M8 20 Q5.5 21 4 22 Q3 22.5 3.5 21 Q4.5 19.5 7 19" fill="${teal}" fill-opacity="${o * 0.45}" stroke="${teal}" stroke-width="0.8" stroke-opacity="${o * 0.6}"/>
      <path d="M8 20 Q10.5 21 12 22 Q13 22.5 12.5 21 Q11.5 19.5 9 19" fill="${teal}" fill-opacity="${o * 0.45}" stroke="${teal}" stroke-width="0.8" stroke-opacity="${o * 0.6}"/>
      <!-- bubbles -->
      <circle cx="3" cy="14" r="0.6" fill="${teal}" fill-opacity="${o * 0.35}"/>
      <circle cx="15" cy="15" r="0.5" fill="${teal}" fill-opacity="${o * 0.3}"/>
  ...
  cigar(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="28" height="10" viewBox="-2 -2 32 16">
      ...
      <!-- cigar band — bright gold -->
      <rect x="17" y="4.8" width="3.5" height="2.4" rx="0.5" fill="${gold}" fill-opacity="${o * 0.6}" stroke="${brown}" stroke-width="0.5" stroke-opacity="${o * 0.6}"/>
      <!-- band emblem/text line -->
      <line x1="17.8" y1="6" x2="19.7" y2="6" stroke="${brown}" stroke-width="0.5" stroke-opacity="${o * 0.5}"/>
      <rect x="18" y="5.3" width="2" height="1" rx="0.3" fill="${brown}" fill-opacity="${o * 0.25}"/>
  ...
  dolphin(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="16" viewBox="-1 -1 26 18">
      <!-- water -->
      <path d="M-1 14 Q6 13 12 14 Q18 15 25 14" fill="none" stroke="${blue}" stroke-width="0.8" stroke-opacity="${o * 0.4}" stroke-linecap="round"/>
      <!-- DOLPHIN — sleek body with slight S-curve wiggle, facing right -->
      <!-- top contour: darker back -->
      <path d="M20 5 Q17 3.5 14 3.5 Q10 3.5 7 4.5 Q4 5.5 2 7 Q1 7.5 0 7" fill="none" stroke="${dark}" stroke-width="1.3" stroke-opacity="${o * 0.8}" stroke-linecap="round"/>
      <!-- bottom contour: lighter belly -->
      ...
      <!-- fill between contours — gradient effect: teal top, silver belly -->
      ...
      <!-- belly highlight — silver -->
      <path d="M4 7.5 Q10 9 18 7.5" fill="none" stroke="${silver}" stroke-width="1.5" stroke-opacity="${o * 0.3}" stroke-linecap="round"/>
      <!-- bottle nose/snout -->
      ...
      <!-- tail flukes -->
      <path d="M0 7 Q-1 5.5 -0.5 4.5 Q0 5.5 0.5 6.5" fill="${dark}" fill-opacity="${o * 0.35}" stroke="${k}" stroke-width="0.8" stroke-opacity="${o * 0.6}"/>
      <path d="M0 7 Q-1 8.5 -0.5 9.5 Q0 8.5 0.5 7.5" fill="${dark}" fill-opacity="${o * 0.35}" stroke="${k}" stroke-width="0.8" stroke-opacity="${o * 0.6}"/>
      <!-- water splash -->
      <circle cx="22" cy="12" r="0.4" fill="${blue}" fill-opacity="${o * 0.3}"/>
      <circle cx="24" cy="13" r="0.3" fill="${blue}" fill-opacity="${o * 0.25}"/>
    </svg>`;
  ...
  pelican(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="22" viewBox="-1 -1 20 24">
      <!-- pier post — brown wood -->
      <rect x="7" y="17" width="4" height="5" rx="0.5" fill="${brown}" fill-opacity="${o * 0.25}" stroke="${brown}" stroke-width="0.8" stroke-opacity="${o * 0.5}"/>
      <!-- big round body — white breast -->
      <ellipse cx="9" cy="12" rx="5" ry="5" fill="${white}" fill-opacity="${o * 0.15}" stroke="${k}" stroke-width="1.5" stroke-opacity="${o}"/>
      <!-- wing folded — darker gray-brown -->
      <path d="M6 9 Q9 8 12 10 Q13 12 12 14 Q9 15 6 13 Z" fill="${k}" fill-opacity="${o * 0.2}" stroke="${k}" stroke-width="0.6" stroke-opacity="${o * 0.4}"/>
      <!-- wing feather lines -->
      <path d="M7 10.5 Q9 10 11 11" fill="none" stroke="${k}" stroke-width="0.4" stroke-opacity="${o * 0.25}"/>
      <path d="M7 12 Q9 11.5 11 12.5" fill="none" stroke="${k}" stroke-width="0.4" stroke-opacity="${o * 0.25}"/>
      <!-- long S-curved neck — white -->
      <path d="M9 7 Q8 4 7 2 Q6.5 0.5 7.5 0 Q9 0 9 1.5" fill="none" stroke="${white}" stroke-width="2" stroke-opacity="${o * 0.6}" stroke-linecap="round"/>
      <path d="M9 7 Q8 4 7 2 Q6.5 0.5 7.5 0 Q9 0 9 1.5" fill="none" stroke="${k}" stroke-width="1" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <!-- head -->
      <circle cx="8" cy="0.8" r="1.5" fill="${white}" fill-opacity="${o * 0.25}" stroke="${k}" stroke-width="1.3" stroke-opacity="${o}"/>
      <!-- eye — dark with yellow ring -->
      <circle cx="7.5" cy="0.5" r="0.6" fill="${yellow}" fill-opacity="${o * 0.6}"/>
      <circle cx="7.5" cy="0.5" r="0.25" fill="${dark}" fill-opacity="${o * 0.8}"/>
      <!-- LONG beak — yellow/orange -->
      <path d="M9 0.8 L17 2.5" fill="none" stroke="${yellow}" stroke-width="1.5" stroke-opacity="${o * 0.7}" stroke-linecap="round"/>
      <!-- beak hook at tip -->
      <path d="M17 2.5 Q17.5 3 17 3.5" fill="none" stroke="${yellow}" stroke-width="1" stroke-opacity="${o * 0.6}" stroke-linecap="round"/>
      <!-- BIG droopy pouch — bright yellow -->
      <path d="M9 1.5 Q11 5.5 14 6 Q16 5.5 17 3.5" fill="${yellow}" fill-opacity="${o * 0.5}" stroke="${yellow}" stroke-width="0.8" stroke-opacity="${o * 0.6}" stroke-linejoin="round"/>
      <!-- pouch texture lines -->
      ...
      <!-- short legs — dark -->
      <line x1="8" y1="17" x2="8" y2="15" stroke="${dark}" stroke-width="1.2" stroke-opacity="${o * 0.4}" stroke-linecap="round"/>
      <line x1="10" y1="17" x2="10" y2="15.5" stroke="${dark}" stroke-width="1.2" stroke-opacity="${o * 0.4}" stroke-linecap="round"/>
      <!-- webbed feet — orange-yellow -->
      <path d="M7 17 L6 17.5 L8 17.5 L9 17" fill="${yellow}" fill-opacity="${o * 0.5}" stroke="${k}" stroke-width="0.5" stroke-opacity="${o * 0.4}"/>
      <path d="M9.5 17 L9 17.5 L11 17.5 L11.5 17" fill="${yellow}" fill-opacity="${o * 0.5}" stroke="${k}" stroke-width="0.5" stroke-opacity="${o * 0.4}"/>
    </svg>`;
  ...
  gopherTortoise(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" viewBox="-2 -2 24 20">
      ...
      <path d="M5 11 Q5 4 10 3 Q15 4 15 11" fill="${brown}" fill-opacity="${o * 0.3}" stroke="${dark}" stroke-width="1.3" stroke-opacity="${o * 0.7}"/>
      <!-- shell scute pattern — darker lines -->
      <path d="M7 7 Q10 5.5 13 7" fill="none" stroke="${dark}" stroke-width="0.5" stroke-opacity="${o * 0.35}"/>
      <path d="M6 9 Q10 7.5 14 9" fill="none" stroke="${dark}" stroke-width="0.5" stroke-opacity="${o * 0.3}"/>
      <line x1="10" y1="3.5" x2="10" y2="10" stroke="${dark}" stroke-width="0.4" stroke-opacity="${o * 0.25}"/>
      <line x1="7.5" y1="5.5" x2="6.5" y2="10" stroke="${dark}" stroke-width="0.3" stroke-opacity="${o * 0.2}"/>
      <line x1="12.5" y1="5.5" x2="13.5" y2="10" stroke="${dark}" stroke-width="0.3" stroke-opacity="${o * 0.2}"/>
      <!-- head poking out left — tan/olive -->
      <ellipse cx="3" cy="9.5" rx="2.5" ry="1.8" fill="${tan}" fill-opacity="${o * 0.3}" stroke="${k}" stroke-width="1" stroke-opacity="${o * 0.8}"/>
      <!-- eye — dark with yellow iris -->
      <circle cx="2" cy="9" r="0.6" fill="${yellow}" fill-opacity="${o * 0.7}"/>
      <circle cx="2" cy="9" r="0.25" fill="${dark}" fill-opacity="${o * 0.9}"/>
      <!-- mouth -->
      <path d="M1 10.5 Q2 10.8 3 10.5" fill="none" stroke="${brown}" stroke-width="0.5" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <!-- stubby front leg — tan/grayish -->
      <path d="M6 11 Q4.5 12 3.5 13.5" stroke="${tan}" stroke-width="1.8" stroke-opacity="${o * 0.6}" stroke-linecap="round" fill="none"/>
      <path d="M3.5 13.5 L2.5 13.5 L3 14 L4 13.5" fill="none" stroke="${tan}" stroke-width="0.6" stroke-opacity="${o * 0.4}"/>
      <!-- stubby back leg -->
      <path d="M14 11 Q15.5 12 16.5 13.5" stroke="${tan}" stroke-width="1.8" stroke-opacity="${o * 0.6}" stroke-linecap="round" fill="none"/>
      <path d="M16.5 13.5 L17.5 13.5 L17 14 L16 13.5" fill="none" stroke="${tan}" stroke-width="0.6" stroke-opacity="${o * 0.4}"/>
      <!-- small tail -->
  ...
  alligator(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="26" height="22" viewBox="-1 -1 28 24">
      <!-- ground/water line — teal -->
      <path d="M-1 16 Q6 15 13 16 Q20 17 27 16" fill="none" stroke="${teal}" stroke-width="0.6" stroke-opacity="${o * 0.4}"/>
      <!-- long flat body — darker green back -->
      <path d="M0 14 Q5 13 10 13.5 Q15 13 20 13.5" fill="${dark}" fill-opacity="${o * 0.2}" stroke="${k}" stroke-width="2" stroke-opacity="${o}" stroke-linecap="round"/>
      <!-- belly — yellowish underside -->
      <path d="M1 15 Q5 15.5 10 15 Q15 15.5 20 15" fill="${yellow}" fill-opacity="${o * 0.1}" stroke="${yellow}" stroke-width="0.8" stroke-opacity="${o * 0.2}"/>
      <!-- armored spine scutes — darker green -->
      <path d="M2 12.5 L3 11.5 L4 12.5" fill="${dark}" fill-opacity="${o * 0.3}" stroke="${dark}" stroke-width="0.6" stroke-opacity="${o * 0.5}"/>
      <path d="M5 12 L6 11 L7 12" fill="${dark}" fill-opacity="${o * 0.25}" stroke="${dark}" stroke-width="0.6" stroke-opacity="${o * 0.5}"/>
      <path d="M8 11.8 L9 10.8 L10 11.8" fill="${dark}" fill-opacity="${o * 0.25}" stroke="${dark}" stroke-width="0.6" stroke-opacity="${o * 0.45}"/>
      <path d="M11 12 L12 11 L13 12" fill="${dark}" fill-opacity="${o * 0.2}" stroke="${dark}" stroke-width="0.5" stroke-opacity="${o * 0.4}"/>
      <path d="M14 12.2 L15 11.2 L16 12.2" fill="${dark}" fill-opacity="${o * 0.15}" stroke="${dark}" stroke-width="0.5" stroke-opacity="${o * 0.35}"/>
      <!-- wide powerful head -->
      <path d="M20 13.5 Q22 12 23 11.5 Q24 11.5 24.5 12.5 Q24 13.5 23 14 Q22 14.5 20 14" fill="${k}" fill-opacity="${o * 0.25}" stroke="${k}" stroke-width="1.3" stroke-opacity="${o * 0.8}"/>
      ...
      <!-- teeth — cream/white -->
      <path d="M25 11 L25.2 10.3 M25.8 10.8 L26 10 M26.5 10.5 L26.7 9.8" fill="none" stroke="${cream}" stroke-width="0.5" stroke-opacity="${o * 0.6}"/>
      <path d="M25 14 L25.2 14.7 M25.8 14.2 L26 15 M26.5 14.8 L26.7 15.5" fill="none" stroke="${cream}" stroke-width="0.5" stroke-opacity="${o * 0.6}"/>
      <!-- nostril -->
      <circle cx="27" cy="11" r="0.4" fill="${dark}" fill-opacity="${o * 0.5}"/>
      <!-- eye — yellow iris with slit pupil -->
      <circle cx="22" cy="11.5" r="0.9" fill="${yellow}" fill-opacity="${o * 0.7}" stroke="${k}" stroke-width="0.4" stroke-opacity="${o * 0.5}"/>
      <ellipse cx="22" cy="11.5" rx="0.15" ry="0.6" fill="#000" fill-opacity="${o * 0.7}"/>
      <!-- TAIL curving UP -->
      ...
      <!-- tail scutes -->
      <path d="M0 11.5 L-0.5 10.5 L0.5 11" fill="none" stroke="${dark}" stroke-width="0.4" stroke-opacity="${o * 0.35}"/>
      <path d="M1 8.5 L0.5 7.5 L1.5 8" fill="none" stroke="${dark}" stroke-width="0.4" stroke-opacity="${o * 0.35}"/>
      <path d="M2 6 L1.5 5 L2.5 5.5" fill="none" stroke="${dark}" stroke-width="0.4" stroke-opacity="${o * 0.3}"/>
      <!-- tail tip -->
      <path d="M3 4 Q3.5 3 4 2.5" fill="none" stroke="${k}" stroke-width="1.5" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <!-- front legs -->
      <path d="M18 14.5 Q17.5 16 17 17" stroke="${k}" stroke-width="1.3" stroke-opacity="${o * 0.6}" stroke-linecap="round" fill="none"/>
      <path d="M17 17 L16 17.5 M17 17 L17 18 M17 17 L18 17.5" fill="none" stroke="${k}" stroke-width="0.5" stroke-opacity="${o * 0.4}"/>
      <!-- back legs -->
      <path d="M6 14.5 Q5.5 16 5 17" stroke="${k}" stroke-width="1.3" stroke-opacity="${o * 0.6}" stroke-linecap="round" fill="none"/>
  ...
  roseateSpoonbill(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="-2 -2 24 26">
      ...
      <line x1="9" y1="14" x2="7.5" y2="18" stroke="${red}" stroke-width="0.8" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <line x1="11" y1="14" x2="12.5" y2="18" stroke="${red}" stroke-width="0.8" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <!-- round pink body — strong pink -->
      <ellipse cx="10" cy="12" rx="4" ry="3" fill="${pink}" fill-opacity="${o * 0.35}" stroke="${pink}" stroke-width="1.2" stroke-opacity="${o * 0.7}"/>
      <!-- wing feather lines — hot pink -->
      <path d="M7 10 Q10 9 13 10.5" fill="none" stroke="${hotpink}" stroke-width="0.8" stroke-opacity="${o * 0.5}"/>
      <path d="M6.5 11.5 Q10 10.5 13.5 12" fill="none" stroke="${hotpink}" stroke-width="0.5" stroke-opacity="${o * 0.4}"/>
      <!-- bright pink wing edges -->
      <path d="M6 12 Q5 13 4.5 14" fill="none" stroke="${hotpink}" stroke-width="1" stroke-opacity="${o * 0.7}" stroke-linecap="round"/>
      <path d="M14 12 Q15 13 15.5 14" fill="none" stroke="${hotpink}" stroke-width="1" stroke-opacity="${o * 0.7}" stroke-linecap="round"/>
      <!-- neck — pink tinted -->
      <path d="M10 9 Q9 7 8 5.5 Q7 4 7 3" fill="none" stroke="${pink}" stroke-width="1.5" stroke-opacity="${o * 0.6}" stroke-linecap="round"/>
      <!-- small head — pink -->
      <circle cx="7" cy="2.5" r="1.3" fill="${pink}" fill-opacity="${o * 0.3}" stroke="${pink}" stroke-width="1" stroke-opacity="${o * 0.7}"/>
      <!-- red crown patch — signature feature -->
      <path d="M6.5 1.5 Q7 1 7.5 1.5" fill="${red}" fill-opacity="${o * 0.4}" stroke="none"/>
      <!-- eye — red iris -->
      <circle cx="6.5" cy="2.2" r="0.4" fill="${red}" fill-opacity="${o * 0.7}"/>
      <circle cx="6.5" cy="2.2" r="0.15" fill="${dark}" fill-opacity="${o * 0.8}"/>
      <!-- THE SPOON BILL — pink, flat, rounded end -->
      <path d="M8 2.8 L12 3.5 Q13.5 3.5 13.5 4.5 Q13.5 5.5 12 5.5 L8 4" fill="${pink}" fill-opacity="${o * 0.3}" stroke="${pink}" stroke-width="0.8" stroke-opacity="${o * 0.7}" stroke-linejoin="round"/>
      <!-- short tail -->
  ...
  seaTurtle(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="22" height="18" viewBox="-2 -2 26 22">
      ...
      <path d="M11 4.5 L11 13.5" fill="none" stroke="${dark}" stroke-width="0.5" stroke-opacity="${o * 0.3}"/>
      <path d="M9 5.5 Q11 4.5 13 5.5" fill="none" stroke="${dark}" stroke-width="0.4" stroke-opacity="${o * 0.25}"/>
      <path d="M8 7.5 Q11 6 14 7.5" fill="none" stroke="${dark}" stroke-width="0.4" stroke-opacity="${o * 0.25}"/>
      <path d="M8 10.5 Q11 9 14 10.5" fill="none" stroke="${dark}" stroke-width="0.4" stroke-opacity="${o * 0.25}"/>
      <path d="M9 12.5 Q11 11.5 13 12.5" fill="none" stroke="${dark}" stroke-width="0.4" stroke-opacity="${o * 0.25}"/>
      <!-- head — greenish with olive tint -->
      <ellipse cx="4.5" cy="7" rx="2" ry="1.3" fill="${k}" fill-opacity="${o * 0.25}" stroke="${k}" stroke-width="1" stroke-opacity="${o * 0.8}"/>
      <!-- eye — gold iris -->
      <circle cx="3.8" cy="6.5" r="0.5" fill="${gold}" fill-opacity="${o * 0.7}"/>
      <circle cx="3.8" cy="6.5" r="0.2" fill="${dark}" fill-opacity="${o * 0.9}"/>
      <!-- front left flipper — spotted pattern -->
      <path d="M7 6 Q4 3 1 2.5 Q2.5 4 5.5 6" fill="${k}" fill-opacity="${o * 0.2}" stroke="${k}" stroke-width="0.8" stroke-opacity="${o * 0.6}" stroke-linejoin="round"/>
      <!-- front right flipper -->
      <path d="M7 12 Q4 15 1 15.5 Q2.5 14 5.5 12" fill="${k}" fill-opacity="${o * 0.2}" stroke="${k}" stroke-width="0.8" stroke-opacity="${o * 0.6}" stroke-linejoin="round"/>
      <!-- flipper spots -->
      <circle cx="3" cy="4" r="0.3" fill="${brown}" fill-opacity="${o * 0.3}"/>
      <circle cx="3" cy="14" r="0.3" fill="${brown}" fill-opacity="${o * 0.3}"/>
      <!-- rear left flipper — shorter -->
      <path d="M15 6.5 Q18 4 20 4 Q19 5.5 16 6.5" fill="${k}" fill-opacity="${o * 0.18}" stroke="${k}" stroke-width="0.6" stroke-opacity="${o * 0.5}" stroke-linejoin="round"/>
      <!-- rear right flipper -->
      <path d="M15 11.5 Q18 14 20 14 Q19 12.5 16 11.5" fill="${k}" fill-opacity="${o * 0.18}" stroke="${k}" stroke-width="0.6" stroke-opacity="${o * 0.5}" stroke-linejoin="round"/>
      <!-- small tail -->
      <path d="M16.5 9 Q18 9 19 8.5" fill="none" stroke="${k}" stroke-width="0.6" stroke-opacity="${o * 0.3}" stroke-linecap="round"/>
      <!-- water bubble hints -->
      <circle cx="20" cy="3" r="0.3" fill="${blue}" fill-opacity="${o * 0.25}"/>
  ...
  hockeyPuck(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="-2 -2 20 20">
      ...
      <!-- ice scratch marks -->
      <path d="M4 12.5 L6 13.5" fill="none" stroke="${blue}" stroke-width="0.2" stroke-opacity="${o * 0.15}"/>
      <path d="M10 12 L12 13" fill="none" stroke="${blue}" stroke-width="0.2" stroke-opacity="${o * 0.15}"/>
      ...
      <!-- stick tape wrap on blade — white -->
      <line x1="7.5" y1="9.5" x2="8" y2="10" stroke="${white}" stroke-width="0.4" stroke-opacity="${o * 0.3}"/>
      <line x1="9" y1="10" x2="9.5" y2="10.5" stroke="${white}" stroke-width="0.4" stroke-opacity="${o * 0.3}"/>
      <!-- puck — 3D cylinder -->
      ...
      <!-- puck logo hint — white -->
      <circle cx="8" cy="12" r="0.8" fill="none" stroke="${white}" stroke-width="0.3" stroke-opacity="${o * 0.25}"/>
      <!-- lightning bolt on stick — BLUE (Tampa Bay Lightning) -->
      <path d="M3.5 4 L4.5 5.5 L3.8 5.5 L4.8 7" fill="none" stroke="${blue}" stroke-width="0.6" stroke-opacity="${o * 0.6}" stroke-linecap="round"/>
      <!-- grip tape on shaft top -->
      <line x1="2.3" y1="2.5" x2="2.8" y2="3" stroke="${black}" stroke-width="0.4" stroke-opacity="${o * 0.35}"/>
      <line x1="2.8" y1="3.2" x2="3.3" y2="3.7" stroke="${black}" stroke-width="0.4" stroke-opacity="${o * 0.35}"/>
      <!-- motion lines -->
  ...
  pirateFlag(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" viewBox="-2 -2 24 18">
      ...
      <!-- pole cap ball — gold -->
      <circle cx="2" cy="0.5" r="0.8" fill="#FBBF24" fill-opacity="${o * 0.6}"/>
      <!-- flag — waving shape with red field -->
      <path d="M3 1.5 Q10 0.5 17 1.5 Q18 3 17.5 5 Q17 7 17.5 9 Q10 10 3 9Z" fill="${k}" fill-opacity="${o * 0.35}" stroke="${k}" stroke-width="0.8" stroke-opacity="${o * 0.7}"/>
      <!-- flag fold shading -->
      ...
      <!-- skull — bright white -->
      <ellipse cx="10" cy="4" rx="2.2" ry="1.8" fill="${white}" fill-opacity="${o * 0.75}" stroke="${white}" stroke-width="0.4" stroke-opacity="${o * 0.5}"/>
      <!-- skull eye sockets -->
      <circle cx="9" cy="3.8" r="0.6" fill="${black}" fill-opacity="${o * 0.8}"/>
      <circle cx="11" cy="3.8" r="0.6" fill="${black}" fill-opacity="${o * 0.8}"/>
      <!-- skull nose -->
      <path d="M9.8 4.5 L10 5 L10.2 4.5" fill="none" stroke="${black}" stroke-width="0.3" stroke-opacity="${o * 0.6}"/>
      <!-- skull teeth -->
      <path d="M9 5.5 L9.5 5.5 L9.5 6 M10 5.5 L10 6 M10.5 5.5 L10.5 6 L11 5.5" fill="none" stroke="${black}" stroke-width="0.3" stroke-opacity="${o * 0.6}"/>
      <!-- crossbones below skull — brighter -->
      <path d="M7 7.5 L13 8.5" fill="none" stroke="${white}" stroke-width="0.8" stroke-opacity="${o * 0.65}" stroke-linecap="round"/>
      <path d="M7 8.5 L13 7.5" fill="none" stroke="${white}" stroke-width="0.8" stroke-opacity="${o * 0.65}" stroke-linecap="round"/>
      <!-- bone ends -->
      <circle cx="7" cy="7.5" r="0.4" fill="${white}" fill-opacity="${o * 0.5}"/>
      <circle cx="13" cy="8.5" r="0.4" fill="${white}" fill-opacity="${o * 0.5}"/>
      <circle cx="7" cy="8.5" r="0.4" fill="${white}" fill-opacity="${o * 0.5}"/>
      <circle cx="13" cy="7.5" r="0.4" fill="${white}" fill-opacity="${o * 0.5}"/>
      <!-- base grass/ground — more visible green -->
      <path d="M0 13 Q2 12.5 4 13" fill="none" stroke="#4ADE80" stroke-width="0.5" stroke-opacity="${o * 0.35}"/>
  ...
  stingray(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="18" viewBox="-2 -2 28 22">
      ...
      <circle cx="8" cy="17" r="0.35" fill="${sand}" fill-opacity="${o * 0.25}"/>
      <circle cx="15" cy="16.5" r="0.3" fill="${sand}" fill-opacity="${o * 0.25}"/>
      <circle cx="20" cy="16" r="0.35" fill="${sand}" fill-opacity="${o * 0.3}"/>
      <!-- body — diamond/kite shape, olive-teal tones -->
      ...
      <!-- darker back pattern -->
      <path d="M12 2 Q9 4 7 6 Q10 5 12 6 Q14 5 17 6 Q15 4 12 2Z" fill="${olive}" fill-opacity="${o * 0.12}"/>
      <!-- body center ridge -->
      ...
      <!-- spots on wings — blue-tinted -->
      <circle cx="7" cy="5.5" r="0.8" fill="${blue}" fill-opacity="${o * 0.15}" stroke="${blue}" stroke-width="0.3" stroke-opacity="${o * 0.25}"/>
      <circle cx="17" cy="5.5" r="0.8" fill="${blue}" fill-opacity="${o * 0.15}" stroke="${blue}" stroke-width="0.3" stroke-opacity="${o * 0.25}"/>
      <circle cx="5" cy="8" r="0.6" fill="${blue}" fill-opacity="${o * 0.1}"/>
      <circle cx="19" cy="8" r="0.6" fill="${blue}" fill-opacity="${o * 0.1}"/>
      <!-- eyes -->
      <circle cx="10.5" cy="4" r="0.7" fill="${dark}" fill-opacity="${o * 0.7}"/>
      <circle cx="13.5" cy="4" r="0.7" fill="${dark}" fill-opacity="${o * 0.7}"/>
      <!-- mouth/gill slits -->
      ...
      <!-- tail — long whip -->
      <path d="M12 10 Q12.5 13 11 15 Q10 16.5 11.5 17.5" fill="none" stroke="${dark}" stroke-width="0.8" stroke-opacity="${o * 0.6}" stroke-linecap="round"/>
      <!-- tail barb — dark -->
  ...
  grouper(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="22" height="14" viewBox="-2 -2 26 18">
      ...
      <!-- darker back — olive tint -->
      <path d="M5 5 Q9 2.5 13 2 Q17 3 19 5 Q16 3 12 3 Q8 3.5 5 5Z" fill="${olive}" fill-opacity="${o * 0.15}"/>
      <!-- dorsal fin — darker -->
      <path d="M8 3 L7 1 L9 2.5 L10 0.5 L11.5 2 L13 0.8 L14 2 L15.5 1 L16 3" fill="${brown}" fill-opacity="${o * 0.2}" stroke="${k}" stroke-width="0.6" stroke-opacity="${o * 0.6}"/>
      <!-- tail fin — forked -->
      ...
      <!-- grouper spots — more visible brown -->
      <circle cx="8" cy="6" r="0.6" fill="${brown}" fill-opacity="${o * 0.35}"/>
      <circle cx="11" cy="5" r="0.5" fill="${brown}" fill-opacity="${o * 0.35}"/>
      <circle cx="14" cy="6.5" r="0.55" fill="${brown}" fill-opacity="${o * 0.3}"/>
      <circle cx="10" cy="8" r="0.5" fill="${brown}" fill-opacity="${o * 0.3}"/>
      <circle cx="15" cy="4.5" r="0.4" fill="${brown}" fill-opacity="${o * 0.28}"/>
      <circle cx="7" cy="9" r="0.45" fill="${brown}" fill-opacity="${o * 0.25}"/>
      <!-- big eye — bright yellow -->
      <circle cx="17.5" cy="5.5" r="1" fill="#FDE68A" fill-opacity="${o * 0.7}"/>
      <circle cx="17.5" cy="5.5" r="0.4" fill="${dark}" fill-opacity="${o * 0.8}"/>
      <!-- wide mouth — darker -->
      <path d="M19.5 6.5 Q20.5 7 20.5 8 Q20 8.5 19 8" fill="none" stroke="${dark}" stroke-width="0.7" stroke-opacity="${o * 0.4}" stroke-linecap="round"/>
      <!-- gill line -->
      ...
      <!-- water bubbles -->
      <circle cx="2" cy="3" r="0.3" fill="${water}" fill-opacity="${o * 0.2}"/>
  ...
  spookHill(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" viewBox="-2 -2 24 18">
      ...
      <path d="M1 11.5 Q5 9 10 7.5 Q15 9 19 11.5" fill="${gray}" fill-opacity="${o * 0.12}" stroke="${gray}" stroke-width="0.5" stroke-opacity="${o * 0.3}"/>
      <!-- road center line (dashed) — yellow -->
      <path d="M3 11 Q7 9 10 8 Q13 9 17 11" fill="none" stroke="${gold}" stroke-width="0.4" stroke-opacity="${o * 0.4}" stroke-dasharray="1.5 1"/>
      <!-- car — on LEFT side, facing uphill -->
      <g transform="rotate(8 5 9)">
        <!-- car body — dark blue -->
        <rect x="2.5" y="8" width="5" height="1.8" rx="0.4" fill="${dark}" fill-opacity="${o * 0.45}" stroke="${k}" stroke-width="0.5" stroke-opacity="${o * 0.5}"/>
        <!-- car cabin/roof -->
        <rect x="3.5" y="6.7" width="3" height="1.5" rx="0.5" fill="${dark}" fill-opacity="${o * 0.3}" stroke="${k}" stroke-width="0.4" stroke-opacity="${o * 0.4}"/>
        <!-- windshield — blue tint -->
        <path d="M6.5 8 L6 6.9" fill="none" stroke="#38BDF8" stroke-width="0.3" stroke-opacity="${o * 0.4}"/>
        <!-- rear window -->
        <path d="M3.5 8 L4 6.9" fill="none" stroke="#38BDF8" stroke-width="0.3" stroke-opacity="${o * 0.3}"/>
        <!-- headlight — yellow glow -->
        <circle cx="7.5" cy="8.5" r="0.4" fill="${gold}" fill-opacity="${o * 0.6}"/>
        <!-- tail light — red -->
        <circle cx="2.5" cy="8.5" r="0.3" fill="${red}" fill-opacity="${o * 0.5}"/>
      </g>
      <!-- wheels -->
      <circle cx="4" cy="10" r="0.7" fill="${dark}" fill-opacity="${o * 0.6}" stroke="${gray}" stroke-width="0.3" stroke-opacity="${o * 0.3}"/>
      <circle cx="7" cy="9.5" r="0.7" fill="${dark}" fill-opacity="${o * 0.6}" stroke="${gray}" stroke-width="0.3" stroke-opacity="${o * 0.3}"/>
      <!-- arrow showing car rolling uphill — purple -->
      ...
      <!-- BIG question marks — GOLD for contrast -->
      <text x="10" y="4.5" font-size="4" font-weight="bold" font-family="sans-serif" fill="${gold}" fill-opacity="${o * 0.7}">?</text>
      <text x="14" y="3" font-size="3.5" font-weight="bold" font-family="sans-serif" fill="${gold}" fill-opacity="${o * 0.6}">?</text>
  ...
  sharkTooth(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="14" height="18" viewBox="-2 -2 18 22">
      ...
      <path d="M3 16 Q2.5 17.5 3.5 18" fill="none" stroke="${brown}" stroke-width="0.8" stroke-opacity="${o * 0.7}" stroke-linecap="round"/>
      <path d="M11 16 Q11.5 17.5 10.5 18" fill="none" stroke="${brown}" stroke-width="0.8" stroke-opacity="${o * 0.7}" stroke-linecap="round"/>
      <path d="M7 17 Q7 17.8 7 18" fill="none" stroke="${brown}" stroke-width="0.6" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <!-- root fill area — brownish -->
      <path d="M4 15 Q7 17 10 15" fill="${brown}" fill-opacity="${o * 0.15}"/>
      <!-- serrated cutting edge — dark -->
      <path d="M2 11 L3 10 L2.5 12 L3.5 11 L3 13" fill="none" stroke="${dark}" stroke-width="0.5" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <path d="M12 11 L11 10 L11.5 12 L10.5 11 L11 13" fill="none" stroke="${dark}" stroke-width="0.5" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <!-- enamel ridge down center -->
      <line x1="7" y1="1.5" x2="7" y2="15" stroke="${k}" stroke-width="0.4" stroke-opacity="${o * 0.15}"/>
      <!-- age/wear lines — darker -->
      <path d="M4 7 Q7 6 10 7" fill="none" stroke="${dark}" stroke-width="0.3" stroke-opacity="${o * 0.2}"/>
      <path d="M3 10 Q7 9 11 10" fill="none" stroke="${dark}" stroke-width="0.3" stroke-opacity="${o * 0.18}"/>
      <path d="M4 13 Q7 12 10 13" fill="none" stroke="${dark}" stroke-width="0.3" stroke-opacity="${o * 0.15}"/>
      <!-- glossy highlight on tip -->
      <path d="M6 2 Q7 1.5 7.5 3" fill="none" stroke="${bone}" stroke-width="0.6" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <!-- sand grain specks -->
      <circle cx="2" cy="15" r="0.3" fill="${sand}" fill-opacity="${o * 0.3}"/>
      <circle cx="12" cy="14" r="0.25" fill="${sand}" fill-opacity="${o * 0.25}"/>
  ...
  tarponFish(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="16" viewBox="-2 -2 28 20">
      ...
      <path d="M2 10 Q4 6 8 4 Q12 2 16 3 Q20 4 22 7 Q23 9 22 11 Q20 13 16 13 Q12 13 8 12 Q4 11 2 10Z" fill="${silver}" fill-opacity="${o * 0.3}" stroke="${k}" stroke-width="1" stroke-opacity="${o}"/>
      <!-- dark blue-green back -->
      <path d="M4 7 Q8 4 12 3 Q16 3.5 20 5 Q18 4 14 4 Q10 4.5 6 6Z" fill="${navy}" fill-opacity="${o * 0.2}"/>
      <!-- large silver scales pattern -->
      <path d="M8 6 Q10 5.5 12 6" fill="none" stroke="${silver}" stroke-width="0.3" stroke-opacity="${o * 0.3}"/>
      <path d="M12 5 Q14 4.5 16 5" fill="none" stroke="${silver}" stroke-width="0.3" stroke-opacity="${o * 0.3}"/>
      <path d="M7 8 Q10 7 13 8" fill="none" stroke="${silver}" stroke-width="0.3" stroke-opacity="${o * 0.25}"/>
      <path d="M13 7 Q16 6 19 7" fill="none" stroke="${silver}" stroke-width="0.3" stroke-opacity="${o * 0.25}"/>
      <path d="M8 10 Q11 9 14 10" fill="none" stroke="${silver}" stroke-width="0.3" stroke-opacity="${o * 0.2}"/>
      <path d="M14 9 Q17 8.5 20 9.5" fill="none" stroke="${silver}" stroke-width="0.3" stroke-opacity="${o * 0.2}"/>
      <!-- big eye — gold iris -->
      <circle cx="5.5" cy="8" r="1.2" fill="${gold}" fill-opacity="${o * 0.3}" stroke="${k}" stroke-width="0.6" stroke-opacity="${o * 0.7}"/>
      ...
      <!-- gill plate — silvery -->
      <path d="M7 6 Q6.5 8 7 10.5" fill="none" stroke="${silver}" stroke-width="0.5" stroke-opacity="${o * 0.4}"/>
      <!-- dorsal fin — darker -->
      <path d="M12 3 Q13 1 14 1.5 Q15 2 15 3" fill="${navy}" fill-opacity="${o * 0.2}" stroke="${k}" stroke-width="0.5" stroke-opacity="${o * 0.5}"/>
      <!-- forked tail -->
      ...
      <!-- water splash drops — blue -->
      <circle cx="1" cy="5" r="0.4" fill="${blue}" fill-opacity="${o * 0.3}"/>
      <circle cx="3" cy="3" r="0.3" fill="${blue}" fill-opacity="${o * 0.25}"/>
  ...
  shipwreck(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="16" viewBox="-2 -2 28 20">
      ...
      <path d="M0 14 Q6 13.5 12 14 Q18 14.5 24 14" fill="none" stroke="${sand}" stroke-width="0.6" stroke-opacity="${o * 0.3}"/>
      <circle cx="3" cy="15" r="0.3" fill="${sand}" fill-opacity="${o * 0.2}"/>
      <circle cx="21" cy="14.5" r="0.25" fill="${sand}" fill-opacity="${o * 0.18}"/>
      <!-- hull — wooden brown, tilted -->
      <path d="M4 13 Q5 10 8 9 L17 8 Q20 8 20 10 L19 13 Q15 14.5 10 14 Q6 13.5 4 13Z" fill="${brown}" fill-opacity="${o * 0.3}" stroke="${brown}" stroke-width="0.8" stroke-opacity="${o * 0.6}" transform="rotate(-12 12 11)"/>
      <!-- hull plank lines — wood colored -->
      <path d="M6 11 L17 10" fill="none" stroke="${brown}" stroke-width="0.3" stroke-opacity="${o * 0.25}" transform="rotate(-12 12 11)"/>
      <path d="M5 12 L18 11" fill="none" stroke="${brown}" stroke-width="0.3" stroke-opacity="${o * 0.22}" transform="rotate(-12 12 11)"/>
      <!-- broken mast — brown wood -->
      <line x1="10" y1="8" x2="9" y2="2" stroke="${brown}" stroke-width="0.8" stroke-opacity="${o * 0.6}" stroke-linecap="round"/>
      <path d="M9 2 L8.5 2.5 M9 2 L9.5 2.3" fill="none" stroke="${brown}" stroke-width="0.5" stroke-opacity="${o * 0.4}" stroke-linecap="round"/>
      <!-- second broken mast stub -->
      <line x1="15" y1="8" x2="14.5" y2="4.5" stroke="${brown}" stroke-width="0.6" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <!-- tattered sail remnant — faded cream -->
      <path d="M9.5 3 Q11 3.5 12 5 Q10.5 5 9.5 4" fill="#FEF3C7" fill-opacity="${o * 0.12}" stroke="${k}" stroke-width="0.4" stroke-opacity="${o * 0.25}"/>
      <!-- hole in hull — dark void -->
      <ellipse cx="12" cy="11" rx="1.2" ry="0.7" fill="${dark}" fill-opacity="${o * 0.4}" stroke="${dark}" stroke-width="0.3" stroke-opacity="${o * 0.3}" transform="rotate(-12 12 11)"/>
      <!-- bubbles rising — teal -->
      <circle cx="13" cy="6" r="0.5" fill="${water}" fill-opacity="${o * 0.15}" stroke="${water}" stroke-width="0.4" stroke-opacity="${o * 0.4}"/>
      <circle cx="11" cy="5" r="0.35" fill="${water}" fill-opacity="${o * 0.12}" stroke="${water}" stroke-width="0.3" stroke-opacity="${o * 0.35}"/>
      <circle cx="14" cy="3.5" r="0.3" fill="${water}" fill-opacity="${o * 0.1}" stroke="${water}" stroke-width="0.3" stroke-opacity="${o * 0.3}"/>
      <!-- seaweed — bright green -->
      <path d="M6 12 Q5.5 10 6.5 8" fill="none" stroke="${green}" stroke-width="0.5" stroke-opacity="${o * 0.35}" stroke-linecap="round"/>
      <path d="M18 11 Q18.5 9 17.5 7.5" fill="none" stroke="${green}" stroke-width="0.45" stroke-opacity="${o * 0.3}" stroke-linecap="round"/>
      <path d="M7 13 Q6 11 7 9" fill="none" stroke="${green}" stroke-width="0.3" stroke-opacity="${o * 0.25}" stroke-linecap="round"/>
      <!-- anchor on sea floor — darker metal -->
      <path d="M20 12 L20 15" fill="none" stroke="${dark}" stroke-width="0.5" stroke-opacity="${o * 0.3}" stroke-linecap="round"/>
  ...
  mantaRay(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="18" viewBox="-2 -2 28 22">
      ...
      <path d="M9 5.5 Q12 7 15 5.5" fill="${white}" fill-opacity="${o * 0.15}" stroke="${white}" stroke-width="0.3" stroke-opacity="${o * 0.2}"/>
      <ellipse cx="12" cy="6" rx="2" ry="0.8" fill="${white}" fill-opacity="${o * 0.1}"/>
      ...
      <!-- body center ridge -->
      <path d="M12 3 Q12 5 12 7" fill="none" stroke="${navy}" stroke-width="0.5" stroke-opacity="${o * 0.3}"/>
      <!-- gill slits — underside markings -->
      <path d="M9 6 L10 5.5" fill="none" stroke="${k}" stroke-width="0.4" stroke-opacity="${o * 0.25}"/>
      <path d="M9.5 7 L10.5 6.5" fill="none" stroke="${k}" stroke-width="0.35" stroke-opacity="${o * 0.2}"/>
      <path d="M15 6 L14 5.5" fill="none" stroke="${k}" stroke-width="0.4" stroke-opacity="${o * 0.25}"/>
      <path d="M14.5 7 L13.5 6.5" fill="none" stroke="${k}" stroke-width="0.35" stroke-opacity="${o * 0.2}"/>
      <!-- eyes -->
      <circle cx="10" cy="4.5" r="0.6" fill="${dark}" fill-opacity="${o * 0.7}"/>
      <circle cx="14" cy="4.5" r="0.6" fill="${dark}" fill-opacity="${o * 0.7}"/>
      <!-- wide mouth -->
      <path d="M10.5 5.5 Q12 6.5 13.5 5.5" fill="none" stroke="${k}" stroke-width="0.4" stroke-opacity="${o * 0.4}"/>
      <!-- long whip tail — darker -->
      <path d="M12 7 Q12 10 11.5 13 Q11 15 10.5 17" fill="none" stroke="${navy}" stroke-width="0.6" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <!-- wing texture — subtle vein lines -->
      <path d="M5 5 Q7 5 9 6" fill="none" stroke="${navy}" stroke-width="0.25" stroke-opacity="${o * 0.2}"/>
      <path d="M19 5 Q17 5 15 6" fill="none" stroke="${navy}" stroke-width="0.25" stroke-opacity="${o * 0.2}"/>
      <!-- spot markings on wings — purple tinted -->
      <circle cx="6" cy="5.5" r="0.5" fill="${blue}" fill-opacity="${o * 0.12}"/>
      <circle cx="18" cy="5.5" r="0.5" fill="${blue}" fill-opacity="${o * 0.12}"/>
      <circle cx="4" cy="7" r="0.4" fill="${blue}" fill-opacity="${o * 0.1}"/>
      <circle cx="20" cy="7" r="0.4" fill="${blue}" fill-opacity="${o * 0.1}"/>
      <!-- water bubbles -->
      <circle cx="1" cy="3" r="0.3" fill="${blue}" fill-opacity="${o * 0.2}"/>
  ...
  spanishMoss(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="22" viewBox="-2 -2 20 26">
      ...
      <!-- green tint on living moss strands — more visible -->
      <path d="M3 5 Q2.5 9 2 13" fill="none" stroke="${green}" stroke-width="0.4" stroke-opacity="${o * 0.3}" stroke-linecap="round"/>
      <path d="M12 4 Q11 8 11 12" fill="none" stroke="${green}" stroke-width="0.35" stroke-opacity="${o * 0.25}" stroke-linecap="round"/>
      <path d="M7 3 Q6.5 8 6 14" fill="none" stroke="${green}" stroke-width="0.3" stroke-opacity="${o * 0.2}" stroke-linecap="round"/>
      <!-- warm sunlight filtering through -->
      <circle cx="8" cy="5" r="1.5" fill="#FBBF24" fill-opacity="${o * 0.06}"/>
  ...
  kerouac(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="18" viewBox="-2 -2 20 22">
      ...
      <rect x="3" y="6.5" width="10" height="2" rx="0.5" fill="${dark}" fill-opacity="${o * 0.2}" stroke="${k}" stroke-width="0.6" stroke-opacity="${o * 0.6}"/>
      <!-- paper coming out of platen — cream/white -->
      <path d="M5 7 L5 1 L11 1 L11 7" fill="${cream}" fill-opacity="${o * 0.3}" stroke="${gray}" stroke-width="0.5" stroke-opacity="${o * 0.4}"/>
      <!-- typed text lines on paper — dark ink -->
      <line x1="6" y1="2.5" x2="10" y2="2.5" stroke="${dark}" stroke-width="0.3" stroke-opacity="${o * 0.5}"/>
      <line x1="6" y1="3.5" x2="9.5" y2="3.5" stroke="${dark}" stroke-width="0.3" stroke-opacity="${o * 0.45}"/>
      <line x1="6" y1="4.5" x2="10" y2="4.5" stroke="${dark}" stroke-width="0.3" stroke-opacity="${o * 0.45}"/>
      <line x1="6" y1="5.5" x2="8.5" y2="5.5" stroke="${dark}" stroke-width="0.3" stroke-opacity="${o * 0.4}"/>
      <!-- platen knob left — metallic -->
      <circle cx="3.5" cy="7.5" r="0.6" fill="${gray}" fill-opacity="${o * 0.3}" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.5}"/>
      <!-- platen knob right -->
      <circle cx="12.5" cy="7.5" r="0.6" fill="${gray}" fill-opacity="${o * 0.3}" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.5}"/>
      <!-- keyboard rows — round keys with contrast -->
      <circle cx="4" cy="10" r="0.5" fill="${cream}" fill-opacity="${o * 0.2}" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.4}"/>
      <circle cx="5.5" cy="10" r="0.5" fill="${cream}" fill-opacity="${o * 0.2}" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.4}"/>
      <circle cx="7" cy="10" r="0.5" fill="${cream}" fill-opacity="${o * 0.2}" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.4}"/>
      <circle cx="8.5" cy="10" r="0.5" fill="${cream}" fill-opacity="${o * 0.2}" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.4}"/>
      <circle cx="10" cy="10" r="0.5" fill="${cream}" fill-opacity="${o * 0.2}" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.4}"/>
      <circle cx="11.5" cy="10" r="0.5" fill="${cream}" fill-opacity="${o * 0.2}" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.4}"/>
      <circle cx="4.5" cy="11.5" r="0.5" fill="${cream}" fill-opacity="${o * 0.15}" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.3}"/>
      <circle cx="6" cy="11.5" r="0.5" fill="${cream}" fill-opacity="${o * 0.15}" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.3}"/>
      <circle cx="7.5" cy="11.5" r="0.5" fill="${cream}" fill-opacity="${o * 0.15}" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.3}"/>
      <circle cx="9" cy="11.5" r="0.5" fill="${cream}" fill-opacity="${o * 0.15}" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.3}"/>
      <circle cx="10.5" cy="11.5" r="0.5" fill="${cream}" fill-opacity="${o * 0.15}" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.3}"/>
      <!-- spacebar row -->
      <rect x="5" y="12.8" width="6" height="0.8" rx="0.3" fill="${gray}" fill-opacity="${o * 0.15}" stroke="${k}" stroke-width="0.25" stroke-opacity="${o * 0.25}"/>
      <!-- ribbon spools — prominent red -->
      <circle cx="5" cy="9" r="0.5" fill="${red}" fill-opacity="${o * 0.5}" stroke="${red}" stroke-width="0.3" stroke-opacity="${o * 0.4}"/>
      <circle cx="11" cy="9" r="0.5" fill="${red}" fill-opacity="${o * 0.5}" stroke="${red}" stroke-width="0.3" stroke-opacity="${o * 0.4}"/>
      <!-- ribbon connecting spools -->
      <line x1="5.5" y1="9" x2="10.5" y2="9" stroke="${red}" stroke-width="0.3" stroke-opacity="${o * 0.3}"/>
      <!-- feet — brown -->
      <rect x="3" y="15" width="1.5" height="0.6" rx="0.2" fill="${brown}" fill-opacity="${o * 0.3}"/>
  ...
  bioluminescence(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" viewBox="-2 -2 24 18">
      ...
      <!-- large bioluminescent blooms — mixed colors -->
      <circle cx="4" cy="6" r="2.5" fill="${k}" fill-opacity="${o * 0.15}"/>
      <circle cx="4" cy="6" r="1.5" fill="${green}" fill-opacity="${o * 0.15}"/>
      <circle cx="4" cy="6" r="0.6" fill="${green}" fill-opacity="${o * 0.5}"/>
      <circle cx="11" cy="5" r="3" fill="${blue}" fill-opacity="${o * 0.1}"/>
      <circle cx="11" cy="5" r="1.8" fill="${k}" fill-opacity="${o * 0.18}"/>
      <circle cx="11" cy="5" r="0.7" fill="${blue}" fill-opacity="${o * 0.5}"/>
      <circle cx="17" cy="7" r="2" fill="${purple}" fill-opacity="${o * 0.1}"/>
      <circle cx="17" cy="7" r="1.2" fill="${purple}" fill-opacity="${o * 0.15}"/>
      <circle cx="17" cy="7" r="0.5" fill="${purple}" fill-opacity="${o * 0.45}"/>
      <!-- scattered sparkle particles — varied colors -->
      <circle cx="2" cy="9" r="0.4" fill="${green}" fill-opacity="${o * 0.45}"/>
      <circle cx="7" cy="3.5" r="0.35" fill="${k}" fill-opacity="${o * 0.45}"/>
      <circle cx="8" cy="8" r="0.3" fill="${blue}" fill-opacity="${o * 0.4}"/>
      <circle cx="14" cy="9" r="0.35" fill="${purple}" fill-opacity="${o * 0.4}"/>
      <circle cx="19" cy="4" r="0.3" fill="${blue}" fill-opacity="${o * 0.35}"/>
      <circle cx="1" cy="4" r="0.25" fill="${green}" fill-opacity="${o * 0.3}"/>
      <circle cx="6" cy="10.5" r="0.3" fill="${blue}" fill-opacity="${o * 0.35}"/>
      <circle cx="13" cy="3" r="0.25" fill="${k}" fill-opacity="${o * 0.3}"/>
      <circle cx="16" cy="10" r="0.3" fill="${green}" fill-opacity="${o * 0.35}"/>
      <circle cx="9.5" cy="10" r="0.25" fill="${purple}" fill-opacity="${o * 0.3}"/>
  ...
  floridaMan(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="-2 -2 22 22">
      ...
      <rect x="3" y="2" width="12" height="2.5" rx="0.3" fill="${red}" fill-opacity="${o * 0.3}" stroke="${red}" stroke-width="0.4" stroke-opacity="${o * 0.5}"/>
      <line x1="4" y1="3.2" x2="14" y2="3.2" stroke="${cream}" stroke-width="0.6" stroke-opacity="${o * 0.6}"/>
      <!-- mugshot — skin tone fill -->
      <circle cx="9" cy="8.5" r="2.5" fill="${skin}" fill-opacity="${o * 0.12}" stroke="${k}" stroke-width="0.5" stroke-opacity="${o * 0.4}"/>
      <!-- eyes -->
      <circle cx="8.2" cy="8" r="0.4" fill="${dark}" fill-opacity="${o * 0.6}"/>
      <circle cx="9.8" cy="8" r="0.4" fill="${dark}" fill-opacity="${o * 0.6}"/>
      <!-- mouth -->
      <path d="M8 9.5 Q9 10.3 10 9.5" fill="none" stroke="${dark}" stroke-width="0.4" stroke-opacity="${o * 0.4}" stroke-linecap="round"/>
      <!-- messy hair -->
      <path d="M7 6 Q8 5 9 5.5 Q10 5 11 6" fill="none" stroke="${dark}" stroke-width="0.4" stroke-opacity="${o * 0.35}" stroke-linecap="round"/>
      <!-- article text lines — dark ink -->
      <line x1="3.5" y1="12" x2="14.5" y2="12" stroke="${dark}" stroke-width="0.35" stroke-opacity="${o * 0.3}"/>
      <line x1="3.5" y1="13.2" x2="14.5" y2="13.2" stroke="${dark}" stroke-width="0.35" stroke-opacity="${o * 0.28}"/>
      <line x1="3.5" y1="14.4" x2="11" y2="14.4" stroke="${dark}" stroke-width="0.35" stroke-opacity="${o * 0.25}"/>
      <!-- ! — prominent gold -->
    ...
    return `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="-2 -2 22 22">
      ...
      <!-- text lines -->
      <line x1="5.5" y1="8" x2="12.5" y2="8" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.25}"/>
      <line x1="5.5" y1="9.5" x2="11" y2="9.5" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.2}"/>
      <line x1="5.5" y1="11" x2="12" y2="11" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.18}"/>
    </svg>`;
  },
  ...
  hurricaneAlley(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="22" height="18" viewBox="-2 -2 26 22">
      ...
      <!-- thick spiral arm 2 -->
      <path d="M11 17 Q17 17 20 14 Q22 11 21 8 Q20 5 17 4 Q14 3 12 5" fill="${gray}" fill-opacity="${o * 0.12}" stroke="${k}" stroke-width="1.2" stroke-opacity="${o * 0.6}" stroke-linecap="round" fill-rule="evenodd"/>
      <!-- inner cloud band wrapping around eye — whiter -->
      <path d="M10 7 Q8 7 7 8 Q6 10 8 11 Q9 12 11 11" fill="${white}" fill-opacity="${o * 0.1}" stroke="${white}" stroke-width="0.7" stroke-opacity="${o * 0.3}" stroke-linecap="round"/>
      <path d="M12 11 Q14 11 15 10 Q16 8 14 7 Q13 6 11 7" fill="${white}" fill-opacity="${o * 0.1}" stroke="${white}" stroke-width="0.7" stroke-opacity="${o * 0.3}" stroke-linecap="round"/>
      <!-- eye wall — bright ring -->
      <circle cx="11" cy="9" r="2.2" fill="none" stroke="${white}" stroke-width="1" stroke-opacity="${o * 0.5}"/>
      <circle cx="11" cy="9" r="2.2" fill="none" stroke="${k}" stroke-width="0.5" stroke-opacity="${o * 0.6}"/>
      <!-- clear eye center — dark blue -->
      <circle cx="11" cy="9" r="1.3" fill="${dark}" fill-opacity="${o * 0.15}"/>
      <circle cx="11" cy="9" r="0.6" fill="${blue}" fill-opacity="${o * 0.15}"/>
      <!-- outer feeder bands — gray -->
      <path d="M3 2 Q1 3 1 5" fill="none" stroke="${gray}" stroke-width="0.5" stroke-opacity="${o * 0.3}" stroke-linecap="round"/>
      <path d="M19 16 Q21 15 21 13" fill="none" stroke="${gray}" stroke-width="0.5" stroke-opacity="${o * 0.3}" stroke-linecap="round"/>
      <path d="M18 2 Q20 3 21 5" fill="none" stroke="${gray}" stroke-width="0.4" stroke-opacity="${o * 0.2}" stroke-linecap="round"/>
      <path d="M4 16 Q2 15 1 13" fill="none" stroke="${gray}" stroke-width="0.4" stroke-opacity="${o * 0.2}" stroke-linecap="round"/>
      <!-- rain streaks -->
      <line x1="3" y1="6" x2="2" y2="8" stroke="${blue}" stroke-width="0.3" stroke-opacity="${o * 0.2}" stroke-linecap="round"/>
  ...
  redTide(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" viewBox="-2 -2 24 18">
      ...
      <!-- red tide bloom layers — murky reddish-brown water -->
      <path d="M0 5 Q5 4 10 5 Q15 6 20 5 L20 8 Q15 9 10 8 Q5 7 0 8Z" fill="${red}" fill-opacity="${o * 0.15}" stroke="${red}" stroke-width="0.6" stroke-opacity="${o * 0.5}"/>
      <path d="M0 8 Q5 7 10 8 Q15 9 20 8 L20 11 Q15 12 10 11 Q5 10 0 11Z" fill="${darkRed}" fill-opacity="${o * 0.12}" stroke="${brown}" stroke-width="0.5" stroke-opacity="${o * 0.35}"/>
      <!-- algae cell clusters — scattered dots with color variety -->
      <circle cx="3" cy="5.5" r="0.8" fill="${red}" fill-opacity="${o * 0.35}"/>
      <circle cx="7" cy="4.5" r="0.6" fill="${brown}" fill-opacity="${o * 0.3}"/>
      <circle cx="12" cy="5" r="0.7" fill="${red}" fill-opacity="${o * 0.32}"/>
      <circle cx="17" cy="5.5" r="0.6" fill="${darkRed}" fill-opacity="${o * 0.3}"/>
      <circle cx="5" cy="7.5" r="0.5" fill="${brown}" fill-opacity="${o * 0.28}"/>
      <circle cx="10" cy="7" r="0.55" fill="${red}" fill-opacity="${o * 0.25}"/>
      <circle cx="15" cy="7.5" r="0.5" fill="${darkRed}" fill-opacity="${o * 0.25}"/>
      <!-- dead fish — belly-up white/gray shapes -->
      <ellipse cx="4" cy="10" rx="1.2" ry="0.5" fill="${white}" fill-opacity="${o * 0.3}" stroke="${gray}" stroke-width="0.3" stroke-opacity="${o * 0.25}"/>
      <path d="M5.2 10 L5.8 9.6 L5.8 10.4Z" fill="${gray}" fill-opacity="${o * 0.2}"/>
      <ellipse cx="16" cy="10.5" rx="1" ry="0.4" fill="${white}" fill-opacity="${o * 0.25}" stroke="${gray}" stroke-width="0.3" stroke-opacity="${o * 0.2}"/>
      <path d="M17 10.5 L17.5 10.2 L17.5 10.8Z" fill="${gray}" fill-opacity="${o * 0.18}"/>
      <!-- murky brown water at bottom -->
      <path d="M0 12 Q5 11.5 10 12 Q15 12.5 20 12" fill="none" stroke="${brown}" stroke-width="0.4" stroke-opacity="${o * 0.25}"/>
  ...
  honeymoonIsland(theme, activated = false) {
    ...
    if (activated) return `<svg xmlns="http://www.w3.org/2000/svg" width="22" height="16" viewBox="-2 -2 26 20">
      ...
      <path d="M11 8 Q10.5 5 11 2 Q11.5 0.5 12 0" fill="none" stroke="${brown}" stroke-width="1" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <!-- trunk texture rings -->
      ...
      <path d="M6 10 Q6 8 5.5 7" fill="none" stroke="${green}" stroke-width="0.3" stroke-opacity="${o * 0.25}" stroke-linecap="round"/>
      <path d="M7 9.5 Q7 7.5 6.5 6.5" fill="none" stroke="${green}" stroke-width="0.3" stroke-opacity="${o * 0.2}" stroke-linecap="round"/>
      <path d="M16 9.5 Q16 7.5 16.5 6.5" fill="none" stroke="${green}" stroke-width="0.3" stroke-opacity="${o * 0.2}" stroke-linecap="round"/>
      <!-- water -->
      <path d="M0 13 Q6 12 11 13 Q16 14 22 13" fill="none" stroke="${water}" stroke-width="0.5" stroke-opacity="${o * 0.35}"/>
      <path d="M0 14.5 Q6 14 11 14.5 Q16 15 22 14.5" fill="none" stroke="${water}" stroke-width="0.35" stroke-opacity="${o * 0.2}"/>
      <!-- birds in distance -->
      <path d="M3 3 Q3.5 2.5 4 3" fill="none" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.15}" stroke-linecap="round"/>
    ...
    return `<svg xmlns="http://www.w3.org/2000/svg" width="22" height="16" viewBox="-2 -2 26 20">
      ...
      <!-- frond hints -->
      <path d="M11 3 Q14 2 15 1" fill="none" stroke="${k}" stroke-width="0.4" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <path d="M11 3 Q8 2 7 1" fill="none" stroke="${k}" stroke-width="0.4" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <path d="M11 3 Q13 4 14 4" fill="none" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.35}" stroke-linecap="round"/>
      <!-- island mound -->
      <path d="M7 11 Q11 9.5 15 11" fill="${k}" fill-opacity="${o * 0.05}" stroke="${k}" stroke-width="0.3" stroke-opacity="${o * 0.3}"/>
      <!-- water -->
      <path d="M2 13 Q11 12 20 13" fill="none" stroke="${k}" stroke-width="0.4" stroke-opacity="${o * 0.35}"/>
    </svg>`;
  },
  ...
  ghostOrchid(theme, activated = false) {
    ...
    return `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" viewBox="-1 -1 18 16">
      ...
      <!-- flower hint -->
      <path d="M7.5 7 Q5.5 6 4.5 6.5" fill="none" stroke="${k}" stroke-width="0.35" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <path d="M7.5 7 Q9.5 6 10.5 6.5" fill="none" stroke="${k}" stroke-width="0.35" stroke-opacity="${o * 0.5}" stroke-linecap="round"/>
      <!-- tendril hints -->
  ...
  // =========================================================================
  // Best of the Bay — POI icons (premium gold silhouettes with dark outlines)
  // =========================================================================

  bernsSteak(theme) {
    const g = '#FBBF24';  // gold
    const s = '#FDE68A';  // shine
    const d = '#1E293B';  // dark outline
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="-1 -1 26 26">
      <path d="M5 6 Q3 8 3 12 Q3 16 6 18 Q10 20 14 19 Q18 18 20 15 Q22 12 21 8 Q20 5 16 4 Q12 3 8 4 Q6 5 5 6Z" fill="${g}" fill-opacity="0.8" stroke="${d}" stroke-width="0.8" stroke-opacity="0.6"/>
      <path d="M10 7 L10 16" stroke="${s}" stroke-width="1.6" stroke-opacity="0.9" stroke-linecap="round"/>
      <path d="M7 9 L14 9" stroke="${s}" stroke-width="1.6" stroke-opacity="0.9" stroke-linecap="round"/>
      <path d="M6 7 Q8 6 10 7" fill="none" stroke="${s}" stroke-width="0.5" stroke-opacity="0.5"/>
      <path d="M13 11 Q15 12 14 14" fill="none" stroke="${d}" stroke-width="0.4" stroke-opacity="0.25"/>
      <path d="M7 12 Q8 14 7 15" fill="none" stroke="${d}" stroke-width="0.3" stroke-opacity="0.2"/>
    </svg>`;
  },
  ...
  flamencoDancer(theme) {
    ...
    const d = '#1E293B';
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="-1 -1 26 26">
      <path d="M8 12 Q6 16 3 21 Q8 23 12 23 Q16 23 21 21 Q18 16 16 12Z" fill="${g}" fill-opacity="0.8" stroke="${d}" stroke-width="0.7" stroke-opacity="0.5"/>
      <path d="M10 14 Q11 18 9 21" fill="none" stroke="${s}" stroke-width="0.5" stroke-opacity="0.5"/>
      <path d="M14 14 Q13 18 15 21" fill="none" stroke="${s}" stroke-width="0.5" stroke-opacity="0.5"/>
      <rect x="10" y="7" width="4" height="5" rx="1" fill="${g}" fill-opacity="0.85" stroke="${d}" stroke-width="0.5" stroke-opacity="0.45"/>
      <circle cx="12" cy="5" r="2.2" fill="${g}" fill-opacity="0.85" stroke="${d}" stroke-width="0.5" stroke-opacity="0.5"/>
      <circle cx="12" cy="3.2" r="1.2" fill="${g}" fill-opacity="0.9"/>
      <path d="M14 8 Q17 6 18 3" fill="none" stroke="${g}" stroke-width="1.3" stroke-opacity="0.8" stroke-linecap="round"/>
      <path d="M10 9 Q8 10 7 11" fill="none" stroke="${g}" stroke-width="1" stroke-opacity="0.7" stroke-linecap="round"/>
      <circle cx="11" cy="4.5" r="0.6" fill="${s}" fill-opacity="0.5"/>
    </svg>`;
  },
  ...
  pirateShipBow(theme) {
    ...
    const d = '#1E293B';
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="-1 -1 26 26">
      <path d="M4 12 L18 12 Q20 12 20 10.5 Q20 9 18 9 L16 9 L16 12" fill="${g}" fill-opacity="0.8" stroke="${d}" stroke-width="0.7" stroke-opacity="0.5"/>
      <circle cx="19.5" cy="10.8" r="1" fill="${d}" fill-opacity="0.3"/>
      <path d="M5 12 L5 17 L17 17 L17 12" fill="${g}" fill-opacity="0.7" stroke="${d}" stroke-width="0.6" stroke-opacity="0.4"/>
      <line x1="8" y1="12" x2="8" y2="17" stroke="${d}" stroke-width="0.4" stroke-opacity="0.2"/>
      <line x1="14" y1="12" x2="14" y2="17" stroke="${d}" stroke-width="0.4" stroke-opacity="0.2"/>
      <circle cx="6" cy="19" r="2.2" fill="${g}" fill-opacity="0.75" stroke="${d}" stroke-width="0.6" stroke-opacity="0.5"/>
      <circle cx="16" cy="19" r="2.2" fill="${g}" fill-opacity="0.75" stroke="${d}" stroke-width="0.6" stroke-opacity="0.5"/>
      <line x1="6" y1="17" x2="6" y2="21" stroke="${d}" stroke-width="0.3" stroke-opacity="0.3"/>
      <line x1="4" y1="19" x2="8" y2="19" stroke="${d}" stroke-width="0.3" stroke-opacity="0.3"/>
      <line x1="16" y1="17" x2="16" y2="21" stroke="${d}" stroke-width="0.3" stroke-opacity="0.3"/>
      <line x1="14" y1="19" x2="18" y2="19" stroke="${d}" stroke-width="0.3" stroke-opacity="0.3"/>
      <path d="M4 11 Q2 9 3 7" fill="none" stroke="${g}" stroke-width="0.7" stroke-opacity="0.6" stroke-linecap="round"/>
      <circle cx="21" cy="18" r="1.3" fill="${g}" fill-opacity="0.8" stroke="${d}" stroke-width="0.4" stroke-opacity="0.4"/>
      <circle cx="23" cy="18" r="1.3" fill="${g}" fill-opacity="0.75" stroke="${d}" stroke-width="0.4" stroke-opacity="0.4"/>
      <circle cx="22" cy="16.5" r="1.3" fill="${g}" fill-opacity="0.85" stroke="${d}" stroke-width="0.4" stroke-opacity="0.4"/>
      <path d="M5 10 L17 10" stroke="${s}" stroke-width="0.4" stroke-opacity="0.4"/>
    </svg>`;
  },
  ...
  lightningBolt(theme) {
    ...
    const d = '#1E293B';
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="-1 -1 26 26">
      <path d="M13 1 L7 11 L11 11 L9 23 L17 10 L13 10Z" fill="${g}" fill-opacity="0.85" stroke="${d}" stroke-width="0.8" stroke-opacity="0.55" stroke-linejoin="round"/>
      <path d="M12.5 4 L9.5 11 L11.5 11 L10 19 L14.5 10.5 L12.5 10.5Z" fill="${s}" fill-opacity="0.4"/>
    </svg>`;
  },
  ...
  meltingClock(theme) {
    ...
    const d = '#1E293B';
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="-1 -1 26 26">
      <line x1="2" y1="10" x2="22" y2="10" stroke="${d}" stroke-width="1" stroke-opacity="0.4"/>
      <path d="M6 5 Q5 5 5 8 Q4 10 3 14 Q3 18 8 19 Q12 20 16 18 Q19 16 19 12 Q19 10 18 8 Q18 5 17 5Z" fill="${g}" fill-opacity="0.8" stroke="${d}" stroke-width="0.7" stroke-opacity="0.5"/>
      <path d="M8 6 Q10 5 14 6 Q16 7 16 9" fill="none" stroke="${s}" stroke-width="0.6" stroke-opacity="0.5"/>
      <line x1="11.5" y1="11" x2="11.5" y2="7.5" stroke="${d}" stroke-width="0.8" stroke-opacity="0.6" stroke-linecap="round"/>
      <line x1="11.5" y1="11" x2="15" y2="12.5" stroke="${d}" stroke-width="0.6" stroke-opacity="0.5" stroke-linecap="round"/>
      <circle cx="11.5" cy="11" r="0.6" fill="${d}" fill-opacity="0.5"/>
      <path d="M8 19 Q8 21 9 22" fill="none" stroke="${g}" stroke-width="0.8" stroke-opacity="0.7" stroke-linecap="round"/>
    </svg>`;
  },
  ...
  cigarIcon(theme) {
    ...
    const d = '#1E293B';
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="-1 -1 26 26">
      <path d="M8 12 Q6 14 6 16 Q6 18 8 19 Q10 20 13 19 Q15 18 16 16 Q16 14 14 12 Q12 11 8 12Z" fill="${g}" fill-opacity="0.8" stroke="${d}" stroke-width="0.7" stroke-opacity="0.5"/>
      <path d="M9 13 Q8 15 9 17" fill="none" stroke="${s}" stroke-width="0.5" stroke-opacity="0.45"/>
      <path d="M10 12 Q9 10 9 8 Q9 6 10 5" fill="none" stroke="${g}" stroke-width="1.8" stroke-opacity="0.85" stroke-linecap="round"/>
      <circle cx="10.5" cy="4.5" r="1.8" fill="${g}" fill-opacity="0.85" stroke="${d}" stroke-width="0.6" stroke-opacity="0.5"/>
      <circle cx="10" cy="4" r="0.5" fill="${d}" fill-opacity="0.5"/>
      <path d="M9 3 Q10 1 11 2 Q12 1 12 3" fill="${g}" fill-opacity="0.9" stroke="${d}" stroke-width="0.4" stroke-opacity="0.4"/>
      <path d="M12 4.5 L14 5 L12 5.5" fill="${g}" fill-opacity="0.85" stroke="${d}" stroke-width="0.3" stroke-opacity="0.35"/>
      <path d="M11 6 Q11.5 7 11 7.5" fill="${g}" fill-opacity="0.7" stroke="${d}" stroke-width="0.3" stroke-opacity="0.3"/>
      <path d="M15 13 Q18 10 19 6" fill="none" stroke="${g}" stroke-width="1.2" stroke-opacity="0.8" stroke-linecap="round"/>
      <path d="M15 14 Q19 12 20 8" fill="none" stroke="${g}" stroke-width="1" stroke-opacity="0.65" stroke-linecap="round"/>
      <path d="M15 15 Q20 14 21 10" fill="none" stroke="${g}" stroke-width="0.7" stroke-opacity="0.5" stroke-linecap="round"/>
      <path d="M10 19 L9 22 M9 22 L7.5 23 M9 22 L10 23" fill="none" stroke="${g}" stroke-width="0.7" stroke-opacity="0.7" stroke-linecap="round"/>
      <path d="M13 19 L14 22 M14 22 L12.5 23 M14 22 L15 23" fill="none" stroke="${g}" stroke-width="0.7" stroke-opacity="0.7" stroke-linecap="round"/>
    </svg>`;
  },
  ...
  bridgeArch(theme) {
    ...
    const d = '#1E293B';
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="-1 -1 26 26">
      <line x1="12" y1="22" x2="12" y2="6" stroke="${g}" stroke-width="1.4" stroke-opacity="0.8" stroke-linecap="round"/>
      <path d="M12 7 Q15 6 17 7 Q18 8 17 9" fill="none" stroke="${g}" stroke-width="1" stroke-opacity="0.75" stroke-linecap="round"/>
      <path d="M12 7 Q9 6 7 7 Q6 8 7 9" fill="none" stroke="${g}" stroke-width="1" stroke-opacity="0.75" stroke-linecap="round"/>
      <path d="M16 7 L18 7 L17.5 10 L16.5 10Z" fill="${g}" fill-opacity="0.85" stroke="${d}" stroke-width="0.4" stroke-opacity="0.45"/>
      <path d="M6 7 L8 7 L7.5 10 L6.5 10Z" fill="${g}" fill-opacity="0.85" stroke="${d}" stroke-width="0.4" stroke-opacity="0.45"/>
      <circle cx="17" cy="8.5" r="1.8" fill="${s}" fill-opacity="0.25"/>
      <circle cx="7" cy="8.5" r="1.8" fill="${s}" fill-opacity="0.25"/>
      <circle cx="17" cy="8.5" r="0.6" fill="${s}" fill-opacity="0.6"/>
      <circle cx="7" cy="8.5" r="0.6" fill="${s}" fill-opacity="0.6"/>
      <rect x="10" y="20" width="4" height="2" rx="0.5" fill="${g}" fill-opacity="0.75" stroke="${d}" stroke-width="0.4" stroke-opacity="0.35"/>
      <rect x="9" y="21.5" width="6" height="1" rx="0.3" fill="${g}" fill-opacity="0.65" stroke="${d}" stroke-width="0.3" stroke-opacity="0.3"/>
      <line x1="1" y1="18" x2="23" y2="18" stroke="${g}" stroke-width="0.5" stroke-opacity="0.35"/>
      <path d="M12 7 L12 6.5" stroke="${s}" stroke-width="0.5" stroke-opacity="0.5" stroke-linecap="round"/>
    </svg>`;
  },
  ...
  ringlingCircus(theme) {
    ...
    const d = '#1E293B';
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="-1 -1 26 26">
      <path d="M3 19 L5 7 Q12 2 19 7 L21 19Z" fill="${g}" fill-opacity="0.8" stroke="${d}" stroke-width="0.7" stroke-opacity="0.5"/>
      <path d="M8 18 L9 6" fill="none" stroke="${s}" stroke-width="0.7" stroke-opacity="0.35"/>
      <path d="M12 18 L12 4" fill="none" stroke="${s}" stroke-width="0.7" stroke-opacity="0.35"/>
      <path d="M16 18 L15 6" fill="none" stroke="${s}" stroke-width="0.7" stroke-opacity="0.35"/>
      <circle cx="12" cy="3.5" r="1.2" fill="${g}" fill-opacity="0.95" stroke="${d}" stroke-width="0.4" stroke-opacity="0.4"/>
      <path d="M12 3 L15 1.5 L12 0.5" fill="${g}" fill-opacity="0.85" stroke="${d}" stroke-width="0.3" stroke-opacity="0.35"/>
      <path d="M9 19 Q12 15 15 19" fill="${d}" fill-opacity="0.15"/>
      <path d="M6 5 Q8 4 12 4" fill="none" stroke="${s}" stroke-width="0.5" stroke-opacity="0.4"/>
    </svg>`;
  },
  ...
  beachUmbrella(theme) {
    ...
    const d = '#1E293B';
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="-1 -1 26 26">
      <line x1="12" y1="7" x2="12" y2="21" stroke="${g}" stroke-width="1" stroke-opacity="0.75" stroke-linecap="round"/>
      <path d="M4 8 Q8 2 12 2 Q16 2 20 8Z" fill="${g}" fill-opacity="0.8" stroke="${d}" stroke-width="0.7" stroke-opacity="0.5"/>
      <path d="M6 7 Q9 4 12 3" fill="none" stroke="${s}" stroke-width="0.6" stroke-opacity="0.5"/>
      <path d="M8 7 Q10 4 12 7" fill="none" stroke="${d}" stroke-width="0.3" stroke-opacity="0.15"/>
      <path d="M12 7 Q14 4 16 7" fill="none" stroke="${d}" stroke-width="0.3" stroke-opacity="0.15"/>
      <path d="M14 17 L18 14 L20 17" fill="none" stroke="${g}" stroke-width="0.8" stroke-opacity="0.6" stroke-linecap="round"/>
      <line x1="16" y1="15.5" x2="16" y2="19" stroke="${g}" stroke-width="0.6" stroke-opacity="0.45"/>
    </svg>`;
  },
  ...
  palmTree(theme) {
    ...
    const d = '#1E293B';
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="-1 -1 26 26">
      <path d="M12 4 L13.5 9 L19 9 L14.5 12.5 L16.5 18 L12 14.5 L7.5 18 L9.5 12.5 L5 9 L10.5 9Z" fill="${g}" fill-opacity="0.8" stroke="${d}" stroke-width="0.7" stroke-opacity="0.5" stroke-linejoin="round"/>
      <path d="M10.5 9 L12 6 L13.5 9" fill="${s}" fill-opacity="0.35"/>
      <circle cx="12" cy="7" r="0.5" fill="${s}" fill-opacity="0.6"/>
      <circle cx="15" cy="10" r="0.5" fill="${s}" fill-opacity="0.5"/>
      <circle cx="9" cy="10" r="0.5" fill="${s}" fill-opacity="0.5"/>
      <circle cx="10" cy="15" r="0.5" fill="${s}" fill-opacity="0.45"/>
      <circle cx="14" cy="15" r="0.5" fill="${s}" fill-opacity="0.45"/>
      <circle cx="12" cy="11" r="1.3" fill="${s}" fill-opacity="0.25"/>
    </svg>`;
  },
  ...
  guitarSilhouette(theme) {
    ...
    const d = '#1E293B';
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="-1 -1 26 26">
      <path d="M9 22 Q5 21 4 18 Q3 15 5 13 Q6 12 6 11 Q5 10 5 8 Q6 6 9 6 Q10 6 10 8 Q10 10 9 11 Q8 12 8 13 Q7 15 8 17 Q9 19 12 19 Q15 19 16 17 Q17 15 16 13 Q15 12 15 11 Q14 10 14 8 Q14 6 15 6 Q18 6 19 8 Q19 10 18 11 Q17 12 18 13 Q21 15 20 18 Q19 21 15 22Z" fill="${g}" fill-opacity="0.8" stroke="${d}" stroke-width="0.7" stroke-opacity="0.5"/>
      <circle cx="12" cy="15" r="2" fill="${d}" fill-opacity="0.2" stroke="${d}" stroke-width="0.5" stroke-opacity="0.35"/>
      <rect x="11" y="1" width="2" height="6" rx="0.5" fill="${g}" fill-opacity="0.8" stroke="${d}" stroke-width="0.5" stroke-opacity="0.4"/>
      <rect x="10" y="0" width="4" height="1.5" rx="0.5" fill="${g}" fill-opacity="0.85" stroke="${d}" stroke-width="0.4" stroke-opacity="0.4"/>
      <line x1="11" y1="2.5" x2="13" y2="2.5" stroke="${s}" stroke-width="0.4" stroke-opacity="0.5"/>
      <line x1="11" y1="4" x2="13" y2="4" stroke="${s}" stroke-width="0.4" stroke-opacity="0.5"/>
      <line x1="11" y1="5.5" x2="13" y2="5.5" stroke="${s}" stroke-width="0.4" stroke-opacity="0.5"/>
      <path d="M6 8 Q7 7 9 8" fill="none" stroke="${s}" stroke-width="0.4" stroke-opacity="0.35"/>
      <path d="M6 14 Q8 13 10 15" fill="none" stroke="${s}" stroke-width="0.4" stroke-opacity="0.3"/>
    </svg>`;
  },
  ...
  donCesar(theme) {
    ...
    const d = '#1E293B';
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="-1 -1 26 26">
      <rect x="4" y="8" width="16" height="13" rx="0.5" fill="${g}" fill-opacity="0.75" stroke="${d}" stroke-width="0.6" stroke-opacity="0.45"/>
      <rect x="9" y="3" width="6" height="6" rx="0.3" fill="${g}" fill-opacity="0.8" stroke="${d}" stroke-width="0.5" stroke-opacity="0.4"/>
      <path d="M9 3 Q12 0 15 3" fill="${g}" fill-opacity="0.85" stroke="${d}" stroke-width="0.5" stroke-opacity="0.4"/>
      <circle cx="12" cy="0.5" r="0.6" fill="${s}" fill-opacity="0.8"/>
      <rect x="4" y="6" width="3" height="3" rx="0.2" fill="${g}" fill-opacity="0.7" stroke="${d}" stroke-width="0.4" stroke-opacity="0.35"/>
      <rect x="17" y="6" width="3" height="3" rx="0.2" fill="${g}" fill-opacity="0.7" stroke="${d}" stroke-width="0.4" stroke-opacity="0.35"/>
      <rect x="6" y="10" width="1.5" height="2" rx="0.3" fill="${d}" fill-opacity="0.15"/>
      <rect x="9" y="10" width="1.5" height="2" rx="0.3" fill="${d}" fill-opacity="0.15"/>
      <rect x="13.5" y="10" width="1.5" height="2" rx="0.3" fill="${d}" fill-opacity="0.15"/>
      <rect x="16.5" y="10" width="1.5" height="2" rx="0.3" fill="${d}" fill-opacity="0.15"/>
      <rect x="6" y="14" width="1.5" height="2" rx="0.3" fill="${d}" fill-opacity="0.12"/>
      <rect x="9" y="14" width="1.5" height="2" rx="0.3" fill="${d}" fill-opacity="0.12"/>
      <rect x="13.5" y="14" width="1.5" height="2" rx="0.3" fill="${d}" fill-opacity="0.12"/>
      <rect x="16.5" y="14" width="1.5" height="2" rx="0.3" fill="${d}" fill-opacity="0.12"/>
      <path d="M10 21 Q12 18 14 21" fill="${d}" fill-opacity="0.12"/>
      <path d="M10 4 Q11 3 12 3.5" fill="none" stroke="${s}" stroke-width="0.5" stroke-opacity="0.5"/>
      <path d="M5 9 Q8 8 12 9" fill="none" stroke="${s}" stroke-width="0.4" stroke-opacity="0.3"/>
    </svg>`;
  },
};
